...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s Plasmacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  Plasmacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Plasmacoin transaction") + "\n" +
              "  Plasmacoin-tx [options] -create [commands]   " + _("Create hex-encoded Plasmacoin transaction") + "\n" +
              "\n";
