...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/Plasmacoin/Plasmacoin>";
    const std::string URL_WEBSITE = "<https://Plasmacoin.org>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("Plasmacoin-loadblk");
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Plasmacoin version %s\n", FormatFullVersion());
}
